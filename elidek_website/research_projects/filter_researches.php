    ...
    <div class="row" id="row">
        <div class="col-md-12">
            ...
            <form class="form-horizontal" name="student-form" method="POST">
                <div class="form-group col-sm-3 mb-3">
                    ...
                    <input class = "form-control", placeholder="Enter start date", name="start_date">
                </div>
				<div class="form-group col-sm-3 mb-3">
                    <label class = "form-label">End Date</label>
                    <input class = "form-control", placeholder="Enter end date", name="end_date">
                </div>
                <div class="form-group col-sm-3 mb-3">
                ...
                <div class="form-group col-sm-3 mb-3">
                    <label class = "form-label">Elidek Manager</label>
                    <input class = "form-control", placeholder="Enter manager ID", name="manager_id">
                </div>
		...
		include '../myelidek.php';
                ...
                if(isset($_POST['submit_creds'])){
					...
					$query = "SELECT res.research_id, res.title, res.start_date, res.end_date, res.duration, res.summary FROM research as res WHERE (($start_date IS NULL OR start_date = '$start_date') AND ($end_date IS NULL OR end_date = '$end_date') AND ($duration IS NULL OR duration = '$duration') AND ($manager_id IS NULL OR manager_id = '$manager_id' ));";
