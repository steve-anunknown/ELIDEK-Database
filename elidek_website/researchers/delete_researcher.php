	...
	<body>
		<nav class="navbar navbar-light navbar-expand-md" id="nav-bar">
			<div id="navbar-div" class="container-fluid">
				<a class="navbar-brand" id="nav-bar-text">Databases ELIDEK Demo - Delete Researcher Page</a>
						...
						<div class="form-group col-sm-3 mb-3">
							<?php
								...
								echo '<div class="form-group col-sm-3 mb-3">';
									echo '<label class = "form-label" style="width: 300px;">Are you sure you want to delete researcher <br><b>' . $row[0] . ' ' . $row[1]. ' ' . $row[2]. ' ' . $row[3]. '?</b></label>';
								echo '</div>';
