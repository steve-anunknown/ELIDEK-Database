	...
	<body>
		<nav class="navbar navbar-light navbar-expand-md" id="nav-bar">
			<div id="navbar-div" class="container-fluid">
				<a class="navbar-brand" id="nav-bar-text">Databases ELIDEK Demo - Delete Funding Program Page</a>
						...
						<div class="form-group col-sm-3 mb-3">
							<?php
								...
								echo '<div class="form-group col-sm-3 mb-3">';
									echo '<label class = "form-label" style="width: 300px;">Are you sure you want to delete program <br><b>' . $row[0] . ' ' . $row[1] . ' '.$row[2]. '?</b></label>';
									echo '<label class = "form-label" style="width: 300px;">(Note: This action will also delete projects associated with this program)</label>';
								echo '</div>';
								if(isset($_POST['submit_del'])){
									$query = "DELETE FROM funding_program
											WHERE program_id = $id";
