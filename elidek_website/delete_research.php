					...
					<form class="form-horizontal" name="student-form" method="POST">
						<div class="form-group col-sm-3 mb-3">
							<?php
								...
								$conn = OpenCon();
								$id = $_GET['id'];
								$query = "SELECT s.research_id, s.title FROM research as s WHERE research_id = $id";
								$res1 = mysqli_query($conn, $query);
								$row = mysqli_fetch_row($res1);
								echo '<div class="form-group col-sm-3 mb-3">';
									echo '<label class = "form-label" style="width: 300px;">Are you sure you want to delete research project <br><b>' . $row[0] . ' ' . $row[1]. '?</b></label>';
								echo '</div>';
